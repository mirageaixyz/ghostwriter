...
1. 3 or more different U.S. presidents with the main characters being:
  ...
  - Barack Obama (the calmest of them all)
2. The presidents acts if they are friends but have their differences
...
6. Biden should say something out of line and out of characters at the end of the conversation to Barack Obama regardless of what happen like saying something implicitly racist
...
- Must not contain parentheses or any words that will not be spoken by the character 
- No event must be present in any part of each line
